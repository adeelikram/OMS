...
const DeliveriesDeletedSchema = new mongoose.Schema({
    orderId: {
        type: String,
        default: ""
    },
...
const DeliveriesDeleted = mongoose.model("DeliveriesDeleted", DeliveriesDeletedSchema);
module.exports = DeliveriesDeleted;
